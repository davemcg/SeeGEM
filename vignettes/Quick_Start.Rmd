...
[demo file](https://cdn.rawgit.com/davemcg/see_gem/master/inst/extdata/demo.html?raw=True)
...
OK, let's try to use your own data. You will need the following:

  1. GEMINI installed (e.g. if you go to your bash shell and type `gemini` it will run (with an error about `too few arguments`)
  2. A GEMINI database
